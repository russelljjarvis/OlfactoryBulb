...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 KA /home/justas/Repositories/OlfactoryBulb/prev_ob_models/Birgiolas2020/MODs/x86_64/KA.mod\n");
...
static int  trates (  double _lv ) {
   ...
   mtau = betm ( _threadargscomma_ _lv ) / ( qt * a0m * ( 1.0 + alpm ( _threadargscomma_ _lv ) ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv - shi + 47.4 ) / 6.0 ) ) ;
   htau = k_tauH * beth ( _threadargscomma_ _lv ) / ( qt * a0h * ( 1.0 + alph ( _threadargscomma_ _lv ) ) ) ;
    return 0; }
